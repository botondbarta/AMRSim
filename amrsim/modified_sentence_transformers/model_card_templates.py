...
class ModelCardTemplate:
    __TAGS__ = ["entrypoints", "feature-extraction", "sentence-similarity"]
    __DEFAULT_VARS__ = {
...
This is a [entrypoints](https://www.SBERT.net) model: It maps sentences & paragraphs to a {NUM_DIMENSIONS} dimensional dense vector space and can be used for tasks like clustering or semantic search.

{MODEL_DESCRIPTION}

## Usage (Sentence-Transformers)

Using this model becomes easy when you have [entrypoints](https://www.SBERT.net) installed:
...
```python
from modified_sentence_transformers import SentenceTransformer
...
Without [entrypoints](https://www.SBERT.net), you can use the model like this: First, you pass your input through the transformer model, then you have to apply the right pooling-operation on-top of the contextualized word embeddings.
